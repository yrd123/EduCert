...
export default class MembershipService extends Component {
    ...
    handleValidation() {
        ...
        if (typeof orginfo["name"] !== "undefined") {
        ...
        if (!orginfo["address"]) {
          ...
          if (typeof orginfo["address"] !== "undefined") {
        ...
        if (typeof orginfo["email"] !== "undefined") {
        ...
        if (!orginfo["password"]) {
          ...
          if (typeof orginfo["password"] !== "undefined") {
          ...
          if (typeof orginfo["contact"] !== "undefined") {
